...
class DenseNet(nn.Module):
    def __init__(self, block, num_block, growth_rate=12, reduction=0.5, num_classes=10, fn_size=1, pool_size=7):
        ...
        self.up1 = nn.ConvTranspose2d(1920,960,3, 2, 1, 1)
        self.up2 = nn.ConvTranspose2d(960, 480, 3, 2, 1, 1)
        self.up3 = nn.ConvTranspose2d(480, 240, 3, 2, 1, 1)
        self.up4 = nn.ConvTranspose2d(240, 120, 3, 2, 1, 1)
        self.conv2 = nn.Conv2d(120,9,1)
